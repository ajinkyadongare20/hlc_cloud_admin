            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <a href="<?php echo site_url('/insert-user'); ?>" class="btn btn-primary mx-1"><i class="fa fa-plus"
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo site_url('/view-user?id=' . $row['pid']); ?>" title="View">
                                            <i class="fas fa-eye" style="color:green; margin-right:8px;"></i>
                                        </a>

                                        <a href="<?php echo site_url('/insert-user?id=' . $row['pid']); ?>" title="Edit">
                                            <i class="fas fa-edit" style="color:#009cff85; margin-right:8px;"></i>
                                        </a>

                                        <a href="<?php echo site_url('/delete-user?pid=' . $row['pid']); ?>"
